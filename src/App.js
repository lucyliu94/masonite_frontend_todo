...
//an empty todo for initalizing the createform
const nullTodo = {
  subject:"",
  details: ""
}
...
const addTodos = async(newTodo) => {
  const response = await fetch(url, {
    method:"post",
    headers: {
      "Content-Type": "application/json" // this is a default 
    },
...
useEffect(() => {
  ...
  return (
    <div className="App">
      ...
      <Link to="/new"><button style={button}>Crreate New To Do </button></Link>
      <Routes>
